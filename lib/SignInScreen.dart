...
// background:
                      ...
                      Positioned.fill(
                        child: Padding(
                          padding:
                              const EdgeInsets.fromLTRB(37.0, 11.0, 36.0, 12.0),
                          child: Stack(
                ...
                Pinned.fromPins(
                  Pin(startFraction: 0.1223, endFraction: 0.5643),
                  Pin(size: 18.0, middle: 0.6072),
                  child: const Text(
                    'Enter password',
                    style: TextStyle(
                      fontFamily: 'DM Sans',
